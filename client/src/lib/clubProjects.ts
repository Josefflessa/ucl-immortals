...
export const CLUB_PROJECT_DEFINITIONS: readonly ClubProjectDefinition[] = [
  ...
  },
  {
    ...
    color: '#60A5FA',
    description: 'Reforça os efeitos da vantagem de formação e dos bônus da tática escolhida durante a partida.',
    foundation: 'Quando sua formação leva vantagem sobre a adversária, você recebe uma vantagem leve durante a partida.',
    nextStep: 'Os bônus de atributos da tática escolhida ficam 50% maiores.',
    levelEffects: [
      'Sua formação recebe uma vantagem leve quando supera a formação adversária.',
      'Os bônus de atributos da tática escolhida ficam 50% maiores em relação ao valor base.',
      'A vantagem de formação passa de leve para clara.',
      'Os bônus de atributos da tática escolhida ficam 100% maiores em relação ao valor base.',
      'A vantagem de formação passa de clara para forte.',
    ],
  },
  {
    id: 'betting',
